...
async(req,res)=>{  // finding any user of same email
    ...
    // route for updating the info of any user

    router.put('/updateInfo/:email', async(req,res)=>{
        try{
            await User.updateOne({email:req.params.email},  // by finding email we can update the info
                {firstName:req.body.firstName,
                 lastName:req.body.lastName,
    ...
    // route to delete any user unfo
     ...
     router.delete('/delete', async(req,res)=>{
         try{                              // deleting finding by email
             await User.deleteOne({email:req.params.email},(error,result)=>{
                if(!error){    // if all ok
                    return res.json({
                        status:true,
